...
void TouchInit(NVM_WRITE_FUNC pWriteFunc, NVM_READ_FUNC pReadFunc, NVM_SECTORERASE_FUNC pSectorErase, void *initValues)
{
	...
	//**	TouchCalibration();
        //**    para que ya no Salga la pantalla de calibracion y cargue los coeficiente de calibracion
        //**TouchCalHWGetPoints();
        //**TouchLoadCalibration();
        //**
   	}	
...
{
    static const XCHAR  scr1StrLn1[] = {'I','M','P','O','R','T','A','N','T','E',0};
    static const XCHAR  scr1StrLn2[] = {'R','e','a','l','i','z','a','r',' ','l','a',0};
    static const XCHAR  scr1StrLn3[] = {'c','a','l','i','b','r','a','c','i','o','n',' ','d','e','l',' ','t','o','u','c','h',0};
    static const XCHAR  scr1StrLn4[] = {'P','r','e','s','i','o','n','e',' ','e','n',' ','e','l',' ','c','e','n','t','r','o',0};
    static const XCHAR  scr1StrLn5[] = {'d','e','l',' ','c','i','r','c','u','l','o',0};
    static const XCHAR  scr1StrLn6[] = {'T','o','q','u','e',' ','e','l',' ','T','o','u','c','h',' ','s','c','r','e','e','n',' ','p','a','r','a',0};
    static const XCHAR  scr1StrLn7[] = {'c','o','n','t','i','n','u','a','r','.',0};
