...
//**************************************************************************************************//
WORD ClearBarGradient(SHORT left, SHORT top, SHORT right, SHORT bottom, GFX_COLOR color1, GFX_COLOR color2, DWORD length, BYTE direction, SHORT leftClear, SHORT topClear, SHORT rightClear, SHORT bottomClear)
{
    ...
    case GRAD_UP:
        ...
        length /= 100;
        steps = length;
        WAIT_UNTIL_FINISH(ClearBar(left,top,right,bottom-steps, leftClear, topClear, rightClear, bottomClear));
        break;
    ...
    case GRAD_DOWN: 
        ...
        length /= 100; 
        steps = length;    
        WAIT_UNTIL_FINISH(ClearBar(left,top+steps,right,bottom, leftClear, topClear, rightClear, bottomClear));    
        break;
    ...
    case GRAD_RIGHT:
        ...
        length /= 100;
        steps = length;
        WAIT_UNTIL_FINISH(ClearBar(left+steps,top,right,bottom, leftClear, topClear, rightClear, bottomClear)); 
        break;
    ...
    case GRAD_LEFT:
        ...
        length /= 100;
        steps = length;
        WAIT_UNTIL_FINISH(ClearBar(left,top,right-steps,bottom, leftClear, topClear, rightClear, bottomClear)); 
        break;
    ...
    for(i=0; i < steps; i++)
    {
        ...
        {
        case GRAD_DOWN:
            WAIT_UNTIL_FINISH(ClearBar(left, top, right, top + barSize, leftClear, topClear, rightClear, bottomClear));
            top += barSize;
        break;
        
        case GRAD_UP:
            WAIT_UNTIL_FINISH(ClearBar(left,bottom - barSize,right,bottom, leftClear, topClear, rightClear, bottomClear));
            bottom -= barSize;
        break;

        case GRAD_RIGHT:
            WAIT_UNTIL_FINISH(ClearBar(left, top, left + barSize, bottom, leftClear, topClear, rightClear, bottomClear));
            left += barSize;
        break;
        
        case GRAD_LEFT:
            WAIT_UNTIL_FINISH(ClearBar(right - barSize, top, right, bottom, leftClear, topClear, rightClear, bottomClear));
            right -= barSize;
        break;
